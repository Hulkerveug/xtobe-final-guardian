...
SRC_URI = " \
    ...
    file://guardian_remember.py \
    file://xtobe-guardian.service \
    file://xtobe-remember.service \
"

S = "${WORKDIR}"

inherit systemd
SYSTEMD_SERVICE:${PN} = "xtobe-guardian.service xtobe-remember.service"
...
do_install() {
    ...
    install -m 0755 ${WORKDIR}/guardian_remember.py \
        ${D}${libexecdir}/xtobe/guardian_remember.py
    ...
    install -m 0644 ${WORKDIR}/xtobe-remember.service \
        ${D}${systemd_system_unitdir}/xtobe-remember.service
}
